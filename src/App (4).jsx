  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section id="home" className="hero-gradient relative min-h-screen flex items-center overflow-hidden">
        {/* Left pattern column.  It remains anchored to the left and underneath the content. */}
        <div
          className="absolute inset-y-0 left-0 w-5/12 md:w-5/12 z-0 pointer-events-none"
          style={{ top: '-2rem' }}
        >
          <img
            src="/pattern1.svg"
        ...
        <ParticlesSystem />
        {/* Hero content aligned to the right.  On larger screens the width is constrained so it doesn’t overlap the pattern. */}
        <div className="relative z-10 ml-auto w-full md:w-7/12 px-6 md:pr-12 lg:pr-20 flex flex-col items-end">
          <img
            src="/OES-logo3.svg"
