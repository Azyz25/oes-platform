      ...
      <section id="features" className="py-20 bg-white">
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {/* Feature card 1 */}
            <div className="interactive-card bg-white p-8 text-center border border-gray-200">
              <div className="w-8 h-8 bg-teal-500 mx-auto mb-4" />
              <h3 className="text-xl font-bold text-gray-800 mb-2">رؤية واضحة</h3>
              <p className="text-gray-600">نسعى لتحقيق التميز المؤسسي في جميع القطاعات</p>
            </div>
            {/* Feature card 2 */}
            <div className="interactive-card bg-white p-8 text-center border border-gray-200">
              <div className="w-8 h-8 bg-teal-500 mx-auto mb-4" />
              <h3 className="text-xl font-bold text-gray-800 mb-2">فريق متخصص</h3>
              <p className="text-gray-600">خبراء في مجال التطوير المؤسسي والجودة</p>
            </div>
            {/* Feature card 3 */}
            <div className="interactive-card bg-white p-8 text-center border border-gray-200">
              <div className="w-8 h-8 bg-teal-500 mx-auto mb-4" />
              <h3 className="text-xl font-bold text-gray-800 mb-2">معايير عالمية</h3>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-6 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <button className="bg-gradient-to-r from-blue-600 to-teal-500 text-white px-8 py-4 font-bold text-lg hover:from-blue-700 hover:to-teal-600 transition-all transform hover:scale-105 shadow-lg">
              سجل معنا الآن
            </button>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <div className="flex space-x-4 space-x-reverse mb-6">
                <a href="#" className="w-10 h-10 bg-white/20 rounded-full flex items-center justify-center hover:bg-white/30 transition-colors social-icon">
                  <WhatsAppIcon />
                </a>
                <a href="#" className="w-10 h-10 bg-white/20 rounded-full flex items-center justify-center hover:bg-white/30 transition-colors social-icon">
